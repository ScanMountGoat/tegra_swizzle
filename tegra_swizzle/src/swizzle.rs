...
mod tests {
    ...
    fn swizzle_deswizzle_bc7_64_64() {
        // Test an even size.
        let swizzled = include_bytes!("../../block_linear/64_bc7_swizzled.bin");
        let deswizzled =
    ...
    fn deswizzle_bc7_64_64() {
        let input = include_bytes!("../../block_linear/64_bc7_swizzled.bin");
        let expected = include_bytes!("../../block_linear/64_bc7_deswizzled.bin");
        let actual =
    ...
    fn deswizzle_bc1_128_128() {
        let input = include_bytes!("../../block_linear/128_bc1_swizzled.bin");
        let expected = include_bytes!("../../block_linear/128_bc1_deswizzled.bin");
        let actual =
    ...
    fn deswizzle_bc3_128_128() {
        let input = include_bytes!("../../block_linear/128_bc3_swizzled.bin");
        let expected = include_bytes!("../../block_linear/128_bc3_deswizzled.bin");
        let actual =
    ...
    fn deswizzle_rgba_f32_128_128() {
        let input = include_bytes!("../../block_linear/128_rgbaf32_swizzled.bin");
        let expected = include_bytes!("../../block_linear/128_rgbaf32_deswizzled.bin");
    ...
    fn deswizzle_bc7_128_128() {
        let input = include_bytes!("../../block_linear/128_bc7_swizzled.bin");
        let expected = include_bytes!("../../block_linear/128_bc7_deswizzled.bin");
        let actual =
            deswizzle_block_linear(128 / 4, 128 / 4, 1, input, BlockHeight::Four, 16).unwrap();
    ...
    fn deswizzle_bc7_256_256() {
        let input = include_bytes!("../../block_linear/256_bc7_swizzled.bin");
        let expected = include_bytes!("../../block_linear/256_bc7_deswizzled.bin");
        let actual =
    ...
    fn deswizzle_bc7_320_320() {
        let input = include_bytes!("../../block_linear/320_bc7_swizzled.bin");
        let expected = include_bytes!("../../block_linear/320_bc7_deswizzled.bin");
        let actual =
    ...
    fn deswizzle_bc7_512_512() {
        let input = include_bytes!("../../block_linear/512_bc7_swizzled.bin");
        let expected = include_bytes!("../../block_linear/512_bc7_deswizzled.bin");
        let actual =
    ...
    fn deswizzle_bc7_1024_1024() {
        let input = include_bytes!("../../block_linear/1024_bc7_swizzled.bin");
        let expected = include_bytes!("../../block_linear/1024_bc7_deswizzled.bin");
        let actual =
    ...
    fn deswizzle_rgba_16_16_16() {
        let input = include_bytes!("../../block_linear/16_16_16_rgba_swizzled.bin");
        let expected = include_bytes!("../../block_linear/16_16_16_rgba_deswizzled.bin");
