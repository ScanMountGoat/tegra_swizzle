...
impl ImageFormat {
    ...
    pub const fn get_tile_size_in_bytes(&self) -> usize {
        match self {
            ImageFormat::Rgba8 => 4,
            ImageFormat::Bc1 => 8,
...
mod tests {
    ...
    #[test]
    fn get_tile_sizes() {
        assert_eq!(4, ImageFormat::get_tile_size_in_bytes(&ImageFormat::Rgba8));
    ...
    #[test]
    fn get_tile_counts() {
        assert_eq!(80, ImageFormat::get_tile_count(&ImageFormat::Rgba8, 5, 16));
    ...
    #[test]
    fn get_tile_dimensions() {
        assert_eq!(1, ImageFormat::get_tile_dimension(&ImageFormat::Rgba8));
        assert_eq!(4, ImageFormat::get_tile_dimension(&ImageFormat::Bc1));
        assert_eq!(4, ImageFormat::get_tile_dimension(&ImageFormat::Bc3));
        assert_eq!(4, ImageFormat::get_tile_dimension(&ImageFormat::Bc7));
        assert_eq!(1, ImageFormat::get_tile_dimension(&ImageFormat::RgbaF32));
    }
}
