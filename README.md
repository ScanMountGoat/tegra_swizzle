...
## Documentation
See the [swizzle](swizzle.md) page for a more formal description of swizzling. While not rigorous enough to be considered a proof, this helps motivate some of the techniques and optimizations applied to this library. The following [swizzling blog post](https://fgiesen.wordpress.com/2011/01/17/texture-tiling-and-swizzling/) also provides some additional insights into swizzling. Note that tegra_swizzle does not use the bit interleaving trick described in the blog post.
